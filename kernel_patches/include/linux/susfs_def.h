...
#define CMD_SUSFS_ADD_SUS_PROC 0x60030

#define SUSFS_MAX_LEN_PATHNAME 256
#define SUSFS_MAX_LEN_COMM 16 // 256 should address many paths already unless you are doing some strange experimental stuff, then set your own desired length
